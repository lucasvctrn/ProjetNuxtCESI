<template>
    <div class="bg-center overflow-hidden text-green-900">
        <div class="container mx-auto px-6 sm:px-12 flex flex-col sm:flex-row items-center relative">
            <div class="ml-10 rounded overflow-hidden w-4/12 flex-none">
            ...
            <div class="ml-10 rounded overflow-hidden w-4/5 flex-none">
                ...
                <p class="text-xl">Nos pâtisseries allient gourmandise et originalité. Nous conservons l'art de la pâtisserie à l'ancienne <br> en ajoutant une touche de modernisme.</p>
                <h2 class="mt-4 mb-4 font-semi-bold text-4xl">Horaire d'ouverture:</h2>
                <p class="text-xl"> - Lundi fermé;</p>
                <p class="text-xl"> - Mardi de 9h00 à 19h30;</p>
                <p class="text-xl"> - Mercredi de 9h00 à 19h30;</p>
                <p class="text-xl"> - Jeudi de 9h00 à 19h30;</p>
                <p class="text-xl"> - Vendredi de 9h00 à 19h30;</p>
